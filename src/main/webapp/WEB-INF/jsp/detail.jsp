...
<DIV>
	...
	<!--      回复、新帖        -->
	<DIV>
		<A href="/post"><IMG src="../../image/reply.gif"  border="0" id=td_post></A>
		<A href="/post"><IMG src="../../image/post.gif"   border="0" id=td_post></A>
	</DIV>
	<!--         翻 页         -->
	<DIV>
		<a href="/detail">上一页</a>|
			...
			<TR class="tr1">
				...
				<TH>
					...
					<DIV class="tipad gray">
						发表：[2017-07-30 10:32] &nbsp;
						最后修改:[2017-07-30 08:37]
						<A href="/manage/doDeleteReply">[删除]</A>
						<A href="/update">[修改]</A>
					</DIV>
				</TH>
			</TR>
